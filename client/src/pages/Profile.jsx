  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div>
        ...
        <p className="text-sm text-slate-500">Manage your personal credentials, contact info, and security settings</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm flex items-center space-x-4">
        ...
        <div>
          ...
          <div className="mt-2 flex items-center space-x-2">
            ...
            <span className="text-xs text-slate-400">Organization Verified</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          ...
          {detailsMsg.text && (
            <div className={`p-3 rounded-xl text-xs mb-4 ${detailsMsg.type === 'success' ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'}`}>
              {detailsMsg.text}
            </div>
          )}
          ...
          <form onSubmit={handleUpdateDetails} className="space-y-3 text-xs">
            ...
            <button
              ...
              className="w-full py-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl transition"
            >
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm">
          ...
          {passMsg.text && (
            <div className={`p-3 rounded-xl text-xs mb-4 ${passMsg.type === 'success' ? 'bg-emerald-50 text-emerald-700' : 'bg-rose-50 text-rose-700'}`}>
              {passMsg.text}
            </div>
          )}
